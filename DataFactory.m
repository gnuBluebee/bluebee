...
for ii = 1:2000
    ...
    fprintf("Count %d in Progressing...\n", ii);
end

fprintf("Data Collecting Complete\n");
...
while index < 2000
     ...
     elseif strcmp(b5, mac)
         sorted_data(ii+1, 5)= data(index+1, 2);
...
sorted_data_double = str2double(sorted_data);
sorted_data_double(:,6) = LOCATION_NUM;
save("nearB"+string(LOCATION_NUM)+"_double.mat","sorted_data_double");
